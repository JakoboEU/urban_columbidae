...
head(community_assembly_output)
```
...
ggplot() +  
  ...
  geom_sf(data = world_cities, aes(geometry = geometry, size = regional_pool_size)) +
  geom_sf(data = world_cities, aes(geometry = geometry, color = mntd_normalised, size = urban_pool_size), show.legend = "point") +
...
ggsave('./figures/geographical_mntd.jpg', width = 3000, units = "px")
```
...
ggplot() +  
  geom_sf(data = country_outlines, aes(geometry = geometry)) +
  geom_sf(data = world_cities, aes(geometry = geometry, size = regional_pool_size)) +
  geom_sf(data = world_cities, aes(geometry = geometry, color = fd_normalised, size = urban_pool_size), show.legend = "point") +
  theme_bw() + theme(legend.position="bottom") + scale_colour_gradient2(
  low = "red",
  mid = "yellow",
  high = "darkgreen",
...
ggsave('./figures/geographical_fd.jpg', width = 3000, units = "px")
```
...
ggplot() +  
  geom_sf(data = country_outlines, aes(geometry = geometry)) +
  geom_sf(data = world_cities, aes(geometry = geometry, size = regional_pool_size)) +
  geom_sf(data = world_cities, aes(geometry = geometry, color = FRic_normalised, size = urban_pool_size), show.legend = "point") +
  theme_bw() + theme(legend.position="bottom") + scale_colour_gradient2(
  low = "red",
  mid = "yellow",
  high = "darkgreen",
