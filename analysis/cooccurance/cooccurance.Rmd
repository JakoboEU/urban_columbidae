...
```{r}
city_presence_to_realm = left_join(cities_to_realms, regional_pools)
city_presence_to_realm = city_presence_to_realm[!is.na(city_presence_to_realm$jetz_scientific_name),]
city_presence_to_realm
```
