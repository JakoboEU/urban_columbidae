...
```{r}
ggnet2(regional_patch_cooccurance, label = T, edge.size = "number_of_pools_sqrt", edge.color = "cooccurance_ratio_colour", legend.position = "bottom")
```

```{r}
jpeg("figures/worldwide_cooccurance.jpg", width=5112, height=5112)
...
```{r}
possible_cooccurrance_by_realm = urban_cooccurance_by_realm %>% group_by(realm, jetz_scientific_name, jetz_scientific_name2) %>% summarise(total_regional_pools = n(), both_present = sum(present_in_city & present_in_city2))
...
```{r}
cooccurrance_by_realm$number_of_pools_sqrt = as.integer(sqrt(cooccurrance_by_realm$total_regional_pools))
cooccurrance_by_realm$cooccurance_ratio = cooccurrance_by_realm$both_present / cooccurrance_by_realm$total_regional_pools

cooccurrance_by_realm$cooccurance_ratio_colour = color.gradient(cooccurrance_by_realm$cooccurance_ratio)

head(cooccurrance_by_realm)
```
...
```{r}
ggnet2(cooccurrance_by_realm[cooccurrance_by_realm$realm == 'Palearctic',], label = T, edge.size = "number_of_pools_sqrt", edge.color = "cooccurance_ratio_colour", legend.position = "bottom")
```
```{r}
ggnet2(cooccurrance_by_realm[cooccurrance_by_realm$realm == 'Australasia',], label = T, edge.size = "number_of_pools_sqrt", edge.color = "cooccurance_ratio_colour", legend.position = "bottom")
```

```{r}
ggnet2(cooccurrance_by_realm[cooccurrance_by_realm$realm == 'Indomalayan',], label = T, edge.size = "number_of_pools_sqrt", edge.color = "cooccurance_ratio_colour", legend.position = "bottom")
```

```{r}
ggnet2(cooccurrance_by_realm[cooccurrance_by_realm$realm == 'Afrotropic',], label = T, edge.size = "number_of_pools_sqrt", edge.color = "cooccurance_ratio_colour", legend.position = "bottom")
```

```{r}
ggnet2(cooccurrance_by_realm[cooccurrance_by_realm$realm == 'Nearctic',], label = T, edge.size = "number_of_pools_sqrt", edge.color = "cooccurance_ratio_colour", legend.position = "bottom")
```

```{r}
ggnet2(cooccurrance_by_realm[cooccurrance_by_realm$realm == 'Neotropic',], label = T, edge.size = "number_of_pools_sqrt", edge.color = "cooccurance_ratio_colour", legend.position = "bottom")
```
