...
`
```{r}
all_columbidae_communities[all_columbidae_communities$city_id == test_city_id2,]
...
```
```{r}
all_resident_columbidae_communities[all_resident_columbidae_communities$city_id == test_city_id2,]
