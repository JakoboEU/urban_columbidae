...
compare_community_to_null_model = function(metric_name, actual_metric_value, null_model_metric_values) {
  ...
  mean_value = min(null_model_metric_values)
  sd_value = max(null_model_metric_values)
...
geom_standardised_histogram = function(name, gg, test_result, mean) {
    ...
    geom_vline(aes(xintercept = 1), color = "#000000", size = 1, linetype = "dashed") + 
    ylab("Number of cities") + xlab("Standardised Response") + ylim(c(0, 220)) +
    labs(title = paste(name, ' (V=', test_result$statistic, ', p-value ', fmt_p_value(test_result), ', mean = ', round(mean, 2), ')', sep=''))
}
...
geom_normalised_histogram = function(name, gg, test_result, mean) {
  ...
  geom_vline(aes(xintercept = 1), color = "#000000", size = 1, linetype = "dashed") + 
  ylab("Number of cities") + xlab("Normalised Response") + ylim(c(0, 220)) +
  labs(title = paste(name, ' (V=', test_result$statistic, ', p-value ', fmt_p_value(test_result), ', mean = ', round(mean, 2), ')', sep=''))
}
```
