...
resident_species_in_cities = resident_species_in_cities[,-1]
...
create_null_model_communities = function(city_id, regional_species) {
...
create_null_model_communities(test_city_id, all_columbidae_communities$jetz_scientific_name[all_columbidae_communities$city_id == test_city_id])
```
...
```{r}
test_null_models = create_null_model_communities(test_city_id, all_columbidae_communities$jetz_scientific_name[all_columbidae_communities$city_id == test_city_id])
...
```{r}
get_community_metrics(create_null_model_communities(test_city_id2, all_columbidae_communities$jetz_scientific_name[all_columbidae_communities$city_id == test_city_id2]))
```
...
create_null_model_test_values = function(city_id, regional_species) {
  null_models = create_null_model_communities(city_id, regional_species)
...
create_null_model_test_values(test_city_id, all_columbidae_communities$jetz_scientific_name[all_columbidae_communities$city_id == test_city_id])
```

```{r}
create_null_model_test_values(test_city_id2, all_columbidae_communities$jetz_scientific_name[all_columbidae_communities$city_id == test_city_id2])
```
...
for (city_id in selected_urban_communities$city_id) {
  city_null_models_all_species = create_null_model_test_values(city_id, all_columbidae_communities$jetz_scientific_name[all_columbidae_communities$city_id == city_id])
...
write_csv(urban_all_species_community_result, './community_all_species_assembly_result.csv')
head(urban_all_species_community_result)
```

```{r create urban_resident_only_species_community_result}
urban_resident_only_species_community_result = data.frame()

for (city_id in selected_resident_only_urban_communities$city_id) {
  city_null_models_resident_species = create_null_model_test_values(city_id, all_resident_columbidae_communities$jetz_scientific_name[all_resident_columbidae_communities$city_id == city_id])
...
```{r}
urban_resident_only_species_community_result = read_csv('./community_resident_species_assembly_result.csv')
...
std_mpd_analysis_plot = geom_standardised_histogram(
  'MPD', 
  ggplot(urban_all_species_community_result, aes(mpd_standardised)), 
  wilcox.test(urban_all_species_community_result$mpd_standardised, mu = 0), 
  mean(urban_all_species_community_result$mpd_standardised)
)
...
norm_mpd_analysis_plot = geom_normalised_histogram(
  'MNTD', 
  ggplot(urban_all_species_community_result, aes(mpd_normalised)), 
  wilcox.test(urban_all_species_community_result$mpd_normalised, mu = 0.5), 
  mean(urban_all_species_community_result$mpd_normalised)
)
...
```{r}
ggplot(urban_community_result, aes(y = fd_normalised, x = as.factor(urban_pool_size))) + geom_boxplot()
```
