...
paste("Species not in dataset", nrow(birdlife_to_jetz_mapping[!birdlife_to_jetz_mapping$jetz_scientific_name %in% all_columbidae_presence$jetz_scientific_name,]))
...
```{r}
all_columbidae_presence[!all_columbidae_presence$jetz_scientific_name %in% birdlife_to_jetz_mapping$jetz_scientific_name,]
```
...
```
Total species in analysis
```{r}
length(unique(all_columbidae_presence$jetz_scientific_name))
```
...
columbidae_tolerance = columbidae_urban_tolerance_tmp[,c('jetz_scientific_name', 'urban_tolerance',  'regional_pools', 'urban_pools', 'urban_tolerance',  'trophic_niche', 'habitat', 'habitat_density', 'primary_lifestyle', 'terminal_branch_length')]
